	...
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
		<header class="mdl-layout__header mdl-layout__header--scroll">
			<div class="mdl-layout__header-row">
				<span class="mdl-layout-title">Requested URL was not found!</span>
				<?php
				...
				<div class="mdl-cell--4-col-phone mdl-cell--6-col-tablet mdl-cell--11-col-desktop">
					<div class="mdl-card mdl-shadow--8dp" style="width: 100%;">
						<div class="mdl-card__title">
							<h1 class="mdl-card__title-text">Error 404</h1>
						</div>
						<div class="mdl-card__supporting-text">
							<i class="material-icons" style="font-size: 1000%; text-align: center; display: block;">&#xE811;</i>
							<p style="text-align: center; font-size: 150%;">The requested URL was not found on this server. If you entered the URL manually please check your spelling and try again.</p>
						</div>
					</div>
				</div>
				<div class="mdl-layout-spacer"></div>
