<?php
	...
	if(isset($_SESSION['sub'])){
		echo '<a class="mdl-navigation__link" href="../php/history.php">History</a>';
		...
		if($result->num_rows == 1){
			echo '<a class="mdl-navigation__link" href="../php/application.php">Staff leaves</a>';
		}
		$statement->close();
		...
		if($result->num_rows == 1){
			...
			<a class="mdl-navigation__link" href="../admin/resetTermPage.php">Reset Term</a>
			</nav>';
			echo "<script>
		        $('#sub-menu').slideUp();
